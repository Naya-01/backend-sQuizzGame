...
router.get('/email/:email', authorize,async function(req, res, next) {
...
router.get('/isAdmin/email/:email', authorize,async function(req, res, next) {
...
router.get('/isAdmin/:id', authorize,async function(req, res, next) {
...
router.delete("/delete/subscription/", authorize,async function (req, res) { 
...
router.get('/isBanned/:id', authorize,async function(req, res, next) {
...
router.get('/subscribers/:id', authorize,async function(req, res, next) {
...
router.get('/all_followers/:id', authorize,async function(req, res, next) {
...
router.get('/all_subscriptions/:id', authorize,async function(req, res, next) {
...
router.get('/subscriptions/:id', authorize,async function(req, res, next) {
...
router.post('/subscribe', authorize,async function(req, res, next) { 
    if(
        !req.body ||
...
router.put('/ban/email/', authorize,async function(req, res, next) {
    if(
        !req.body ||
        (req.body.hasOwnProperty("email") && req.body.email.length === 0)
    )
...
/* ban someone by id */
router.put('/ban', authorize,async function(req, res, next) { 
    if(
        !req.body ||
        (req.body.hasOwnProperty("id_user") && req.body.id_user.length === 0)
    )
...
router.put('/unban', authorize,async function(req, res, next) {
    if(
        !req.body ||
        (req.body.hasOwnProperty("id_user") && req.body.id_user.length === 0)
    )
...
router.put('/upAdmin/email', authorize,async function(req, res, next) {
    if(
        !req.body ||
        (req.body.hasOwnProperty("email") && req.body.email.length === 0)
    )
...
router.get('/filter/:filter',authorize,async function(req, res, next) {
...
router.get('/getTwoUsers/ids/', authorize,async function(req, res, next) {
...
router.get('/isFollowing/ids/', authorize,async function(req, res, next) {
...
/* password match */
router.post('/matchPass',async function(req, res, next) {
    if(
        !req.body ||
        (req.body.hasOwnProperty("email") && req.body.email.length === 0) ||
        (req.body.hasOwnProperty("password")&& req.body.password.length === 0)
